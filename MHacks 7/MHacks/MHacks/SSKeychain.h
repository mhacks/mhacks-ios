 ...
 */
+ (NSString * _Nullable)passwordForService:(NSString *)serviceName account:(NSString *)account;
+ (NSString * _Nullable)passwordForService:(NSString *)serviceName account:(NSString *)account error:(NSError **)error __attribute__((swift_error(none)));
...
/**
 ...
 have a password for the given parameters.
 */
+ (NSData * _Nullable)passwordDataForService:(NSString *)serviceName account:(NSString *)account;
+ (NSData * _Nullable)passwordDataForService:(NSString *)serviceName account:(NSString *)account error:(NSError **)error __attribute__((swift_error(none)));
 ...
 */
+ (NSArray *)accountsForService:(NSString * _Nullable)serviceName;
+ (NSArray *)accountsForService:(NSString * _Nullable)serviceName error:(NSError *__autoreleasing *)error __attribute__((swift_error(none)));
